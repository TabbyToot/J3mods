...
.method public onSapStateChanged(Z)V
    .locals 3
    ...
    const-string v2, "onSapStateChanged() isshowing:"
    ...
    # getter for: Lcom/android/systemui/keyguard/KeyguardViewMediator;->mReshowWhenSapDisconnect:Z
    invoke-static {v2}, Lcom/android/systemui/keyguard/KeyguardViewMediator;->access$2100(Lcom/android/systemui/keyguard/KeyguardViewMediator;)Z
    ...
    # setter for: Lcom/android/systemui/keyguard/KeyguardViewMediator;->mReshowWhenSapDisconnect:Z
...
.method public onSimStateChanged(IILcom/android/internal/telephony/IccCardConstants$State;)V
    ...
    const-string v5, "onSimStateChanged(subId="
    ...
    invoke-static {v3}, Lcom/android/systemui/keyguard/KeyguardViewMediator;->access$1400(Lcom/android/systemui/keyguard/KeyguardViewMediator;)Lcom/android/keyguard/KeyguardUpdateMonitor;
    ...
    # getter for: Lcom/android/systemui/keyguard/KeyguardViewMediator;->mUpdateMonitor:Lcom/android/keyguard/KeyguardUpdateMonitor;
    invoke-static {v2}, Lcom/android/systemui/keyguard/KeyguardViewMediator;->access$1400(Lcom/android/systemui/keyguard/KeyguardViewMediator;)Lcom/android/keyguard/KeyguardUpdateMonitor;
    ...
    # invokes: Lcom/android/systemui/keyguard/KeyguardViewMediator;->handleSimSecureStateChanged(Z)V
    invoke-static {v2, v1}, Lcom/android/systemui/keyguard/KeyguardViewMediator;->access$1500(Lcom/android/systemui/keyguard/KeyguardViewMediator;Z)V

    .line 566
    .end local v1    # "simPinSecure":Z
    :cond_1
    sget-object v2, Lcom/android/systemui/keyguard/KeyguardViewMediator$18;->$SwitchMap$com$android$internal$telephony$IccCardConstants$State:[I
    ...
    const-string v4, "Ignoring state: "
    ...
    invoke-static {v2}, Lcom/android/systemui/keyguard/KeyguardViewMediator;->access$1700(Lcom/android/systemui/keyguard/KeyguardViewMediator;)Z
    ...
    const-string v3, "onSimStateChanged getPINPUKRequest( false ) "
    ...
    invoke-virtual {v2, p2}, Lcom/android/keyguard/KeyguardUpdateMonitor;->getSimActiveState(I)Z
    ...
    const-string v3, "Skip  doKeyguardLocked casue current slot is not activated by SIM Card Manager"
    ...
    invoke-virtual {v2, v3}, Lcom/android/keyguard/KeyguardUpdateMonitor;->getNextSubIdForState(Lcom/android/internal/telephony/IccCardConstants$State;)I
    ...
    const-string v3, "INTENT_VALUE_ICC_LOCKED and keygaurd isn\'t showing; need to show keyguard so user can enter sim perso"
    ...
    const-string v3, "send the handler LAUNCH_PERSO_LOCK"
    ...
    invoke-static {v2}, Lcom/android/systemui/keyguard/KeyguardViewMediator;->access$1800(Lcom/android/systemui/keyguard/KeyguardViewMediator;)Landroid/os/Handler;
