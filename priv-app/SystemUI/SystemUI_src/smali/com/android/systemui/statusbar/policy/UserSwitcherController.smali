...
.field private mAddUserOnClickListener:Landroid/view/View$OnClickListener;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/policy/KeyguardMonitor;)V
    ...
    iput v0, p0, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->mAvatarSize:I
    ...
    .line 130
    invoke-direct {p0}, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->initMobileData()V
...
.method static synthetic access$100(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/systemui/statusbar/policy/UserSwitcherController;

    .prologue
    .line 74
    iget v0, p0, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->mAvatarSize:I
...
.method static synthetic access$800(Lcom/android/systemui/statusbar/policy/UserSwitcherController;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/systemui/statusbar/policy/UserSwitcherController;
...
.method private handleVzwUserChange(I)V
    ...
    const-string v1, "com.samsung.vzw.activationagent"
...
.method private initMobileData()V
    ...
    invoke-direct {p0, v2}, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->setMobileDataMultiUser(Z)V
...
.method private setMobileDataMultiUser(Z)V
    .locals 8
    .param p1, "isGuest"    # Z
    ...
    .line 343
    :goto_0
    const-string v5, "UserSwitcherController"
    ...
    invoke-static {v5, v6, v3, v1}, Landroid/provider/Settings$Secure;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
    ...
    invoke-static {v5, v6, v4, v1}, Landroid/provider/Settings$Secure;->putIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
...
.method private setWifiApMultiUser(Z)V
    .locals 8
    .param p1, "isGuest"    # Z
    ...
    invoke-static {v5, v6, v4, v4}, Landroid/provider/Settings$Secure;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    const-string v6, "setWifiApMultiUser userId = "
    ...
    invoke-static {v5, v6, v4, v0}, Landroid/provider/Settings$Secure;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    .line 311
    :cond_4
    invoke-virtual {v1, v7, v2}, Landroid/net/wifi/WifiManager;->setWifiApEnabled(Landroid/net/wifi/WifiConfiguration;Z)Z

    goto :goto_1
.end method

.method private setWifiApOwnerState()V
    .locals 5
    ...
    const-string v4, "setWifiApOwnerState "
...
.method private switchToUserId(I)V
    ...
    .prologue
    .line 391
    invoke-direct {p0}, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->setWifiApOwnerState()V
    ...
    .line 393
    invoke-direct {p0}, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->setMobileDataOwnerState()V
...
.method public getAddUserClickListener()Landroid/view/View$OnClickListener;
    .locals 1

    .prologue
    .line 688
    iget-object v0, p0, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->mAddUserOnClickListener:Landroid/view/View$OnClickListener;
...
.method public setAddUserClickListener(Landroid/view/View$OnClickListener;)V
    .locals 0
    .param p1, "mOnClickListener"    # Landroid/view/View$OnClickListener;

    .prologue
    .line 684
    iput-object p1, p0, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->mAddUserOnClickListener:Landroid/view/View$OnClickListener;
...
.method public switchTo(Lcom/android/systemui/statusbar/policy/UserSwitcherController$UserRecord;)V
    ...
    invoke-direct {p0, v2}, Lcom/android/systemui/statusbar/policy/UserSwitcherController;->setWifiApMultiUser(Z)V
