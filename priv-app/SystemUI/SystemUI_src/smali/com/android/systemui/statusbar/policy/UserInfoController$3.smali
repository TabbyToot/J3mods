...
.method protected varargs doInBackground([Ljava/lang/Void;)Landroid/util/Pair;
    ...
    iget-object v9, p0, Lcom/android/systemui/statusbar/policy/UserInfoController$3;->val$userName:Ljava/lang/String;
    ...
    invoke-static {v10, v1, v2}, Lcom/android/systemui/BitmapHelper;->createCircularClip(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    .line 164
    .local v8, "mDefault":Landroid/graphics/drawable/Drawable;
    new-instance v6, Landroid/graphics/drawable/BitmapDrawable;
    ...
    invoke-static {v8, v1, v2}, Lcom/android/systemui/BitmapHelper;->createCircularClip(Landroid/graphics/drawable/Drawable;II)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v5}, Lcom/android/systemui/statusbar/policy/UserInfoController;->access$002(Lcom/android/systemui/statusbar/policy/UserInfoController;Z)Z

    goto :goto_0

    .line 162
    .end local v8    # "mDefault":Landroid/graphics/drawable/Drawable;
    :cond_3
    iget v0, p0, Lcom/android/systemui/statusbar/policy/UserInfoController$3;->val$userId:I
